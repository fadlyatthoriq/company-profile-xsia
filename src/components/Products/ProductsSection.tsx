...
export default function ProductsSection() {
  return (
    ...
    >
      ...
      {/* Header Section */}
      <div className="relative text-center max-w-2xl mb-20 z-10">
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full z-10">
        ...
        >
          <div className="flex flex-col items-start space-y-4">
            ...
            <button className="mt-4 px-5 py-2.5 rounded-lg bg-cyan-400/5 text-cyan-300 font-medium 
        ...
        >
          <div className="flex flex-col items-start space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Smart retail planning software that helps manage sales, inventory,
              and analytics with real-time precision.
            </p>
            
            <button className="mt-4 px-5 py-2.5 rounded-lg bg-pink-400/5 text-pink-300 font-medium 
        ...
        >
          <div className="flex flex-col items-start space-y-4">
            ...
            <button className="mt-4 px-5 py-2.5 rounded-lg bg-emerald-400/5 text-emerald-300 font-medium 
